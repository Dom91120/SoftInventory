...
function parseForm(formData: FormData) {
  return editeurSchema.safeParse({
    ...
    commercialContact2: formData.get("commercialContact2") ?? "",
    commercialTelephone2: formData.get("commercialTelephone2") ?? "",
    commercialEmail2: formData.get("commercialEmail2") ?? "",
