...
// UNIQUE de la conversion instant ↔ heure murale FR + gestion DST (hiver/été), utilisée
// par la tâche cron des échéances (horaire « quotidien à HH:MM » en heure de Paris).

/** Clés de jour ISO indexées par getDay() (0 = dimanche). */
...
export function parisParts(d: Date): {
  ...
  // Jour de semaine dérivé de la date murale via ISO_DAY_KEYS (index getDay 0=dim).
